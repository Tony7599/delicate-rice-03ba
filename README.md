...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/delicate-rice-03ba)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-rice-03ba
```

A live public deployment of this template is available at [https://delicate-rice-03ba.templates.workers.dev](https://delicate-rice-03ba.templates.workers.dev)
